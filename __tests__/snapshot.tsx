...
describe('snapshot', () => {
  it('build WebsiteCardIntroduction', () => {
    const analysisData = {
      url: 'https://blog.qingtian.me/',
      title: '向之礼的个人博客',
      description: '一个打工人的个人博客小站',
      image: 'https://images.weserv.nl/?url=https://blog.qingtian.me/images/avatar.jpg',
      favicon:
        'https://t3.gstatic.com/faviconV2?client=SOCIAL&type=FAVICON&fallback_opts=TYPE,SIZE,URL&url=https://blog.qingtian.me/&size=16',
    };
  ...
  it('build WebsiteCardIntroductionError', () => {
    const { container } = render(<WebsiteCardIntroductionError url="https://blog.qingtian.me/" />);
    expect(container).toMatchSnapshot();
  });
});
